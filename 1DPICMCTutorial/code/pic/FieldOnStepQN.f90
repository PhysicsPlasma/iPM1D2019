Module ModuleOneStepFieldQN
  ...
  Use ModuleOneStepField
    ...
    contains
         ...
         subroutine FieldOneStepQN(Ns,FO,FG,FB,FS,FSQNS,FSQNB,PB)
            Implicit none
...
End Module ModuleOneStepFieldQN